export function get_medium_payload() {
  return {
    ...
    data: [
      {
        ...
        inops_data: {
          ...
          multiproducts: ["followfeed-models", "followfeed-storage"],
          services: ["followfeed-models", "followfeed-storage"],
        },
        apps: ["followfeed-models", "followfeed-storage"],
        app_owners: [],
        actionable: "yes",
        ...
        faults: [
          {
            ...
            health_check_url:
              "https://obhc-api.prod.example.com/prod-lor1/api/v2/hosts/lor1-app37074.prod.example.com?show_checks=true&show_extra=true",
            fault_type: "disk",
            team: "dctechs",
            description:
              "mdadm has detected a degraded array. A major disk failure has occurred, data loss is possible, replace disk now.",
            is_manual: false,
            component: "",
            jira_ticket: "",
            jira_url: "",
      ...
      },
      {
        ...
        inops_data: {
          ...
          manufacturer: "SuperMicro",
          multiproducts: ["espresso"],
          services: ["espresso-storage-node"],
        },
        apps: ["espresso-storage-node"],
        app_owners: ["espresso-sre@linkedin.com"],
        actionable: "no",
        ...
        faults: [
          {
            ...
            jira_url:
              "https://jira-stg.corp.example.com:8443/browse/DCTECHS-204546",
            created: "Tue, 28 Jun 2022 05:59:13 UTC",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["storops-sds-nvmesh"],
          services: ["storops-sds-nvmesh"],
        },
        apps: ["storops-sds-nvmesh"],
        app_owners: [],
        actionable: "yes",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "R740XD",
          manufacturer: "Dell",
          multiproducts: ["northguard", "kmon-agent"],
          services: ["northguard", "kmon-agent"],
        },
        apps: ["northguard", "kmon-agent"],
        app_owners: [],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        ...
        hooks_plan_id: "",
        fault_types: ["disk"],
        check_ids: ["perc_tooling", "perc_slot_state"],
        total_faults: 2,
        blessin_enabled: false,
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei4/api/v2/hosts/lor1-0003193.int.example.com?show_checks=true&show_extra=true",
            fault_type: "disk",
            team: "dctechs",
        ...
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app4225.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "disk",
            team: "dctechs",
            description:
              "SMARTD has detected a drive that is failing.  This drive has passed thresholds for health checks.  When the drive fails or is replaced, the RAID array will have to perform data reconstruction, which is an expensive I/O process and can effect production applications. The SMARTD should have been enabled on this host but it is not.",
      ...
      },
      {
        ...
        inops_data: {
          ...
          services: ["flame-graph-data-pack", "edge-collector", "l0proxy-ats"],
        },
        apps: [
          "edge-collector",
          "ats-tier-l0proxy",
        ...
        hooks_plan_id: "",
        fault_types: ["disk"],
        check_ids: ["megaraid_full_health"],
        total_faults: 1,
        blessin_enabled: false,
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.prod.example.com/ei-ltx1/api/v2/hosts/ltx1-app1542.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "disk",
            team: "dctechs",
            description:
              "One or More physical and virtual disks are not healthy. Hardware raid controller disk failure found. Operation can continue normally, but risk of data loss exists.",
            is_manual: false,
            component: "",
            jira_ticket: "",
            jira_url: "",
      ...
      },
      {
        ...
        hooks_plan_id: "",
        fault_types: ["power"],
        check_ids: ["power_sm_psu_imbalance"],
        total_faults: 1,
        blessin_enabled: false,
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app10023.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "power",
            team: "dctechs",
            description:
              "The power supplies on SuperMicro systems have imbalanced power outputs. This fails due to faulty power supplies that must be replaced.",
            is_manual: false,
      ...
      },
      {
        ...
        hooks_plan_id: "",
        fault_types: ["power"],
        check_ids: ["power_dell_current_imbalance"],
        total_faults: 1,
        blessin_enabled: false,
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei4/api/v2/hosts/lor1-0002842.int.example.com?show_checks=true&show_extra=true",
            fault_type: "power",
            team: "dctechs",
            description:
              "The power supplies on Dell systems have imbalanced current outputs. This might be due to a system misconfiguration. To mitigate, run: 'racadm set System.ServerPwr.PSRedPolicy 0'",
            is_manual: false,
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["nw-fuse-counting"],
          services: ["fuse-server-counting"],
        },
        apps: ["fuse-server-counting"],
        app_owners: ["trustsre-blr@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Skylake or CXL Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["pinot-server"],
          services: ["pinot-server"],
        },
        apps: ["pinot-server"],
        app_owners: ["pinot-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
      ...
      },
      {
        ...
        apps: ["multiproduct-post-commit-mpdep"],
        app_owners: ["mp-pcx@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
      ...
      },
      {
        ...
        apps: ["rsvp"],
        app_owners: ["growth-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Skylake or CXL Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["tscp-serving"],
          services: ["tscp-index"],
        },
        apps: ["tscp-serving"],
        app_owners: ["adsrv-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "DL C6420",
          manufacturer: "Dell",
          multiproducts: ["vector-asset-manager", "organization", "ugc"],
          services: ["vector-asset-manager", "organization", "ugc"],
        },
        apps: ["organization", "eis-backend", "vector-asset-manager"],
        app_owners: [
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Skylake or CXL Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["deadpool-ui-fe", "deadpool-api"],
          services: ["deadpool-ui-fe", "deadpool-api"],
        },
        apps: ["deadpool-ui-fe", "deadpool-api"],
        app_owners: ["deadpool-team@linkedin.com", "sdi-dev@linkedin.com"],
        actionable: "yes",
        workflow_state: "Get Server Ready",
        hooks_phase_name: "",
        hooks_phase_status: "",
        hooks_enabled: false,
        hooks_plan_id: "",
        fault_types: ["nvme_reboot"],
        check_ids: ["cli_created_nvme_reboot"],
        total_faults: 1,
        blessin_enabled: true,
        faults: [
          {
      ...
      },
      {
        ...
        hooks_enabled: false,
        hooks_plan_id: "",
        fault_types: ["disk", "nvme_reboot"],
        check_ids: ["cli_created_disk", "cli_created_nvme_reboot"],
        total_faults: 2,
        blessin_enabled: true,
        faults: [
          {
      ...
      },
      {
        ...
        hooks_enabled: false,
        hooks_plan_id: "",
        fault_types: ["virident"],
        check_ids: ["virident_flash"],
        total_faults: 1,
        blessin_enabled: true,
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app0845.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "virident",
            team: "dctechs",
            description:
              "A Virident card has failed. These cards are used on critical systems, so this a critical alert. Virident card flash headroom percentage of read only - bad flash is less than 2%. Please check.",
            is_manual: false,
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Skylake or CXL Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["databus-monitor", "databus2", "databus-events"],
          services: ["databus-monitor", "databus2-relay", "databus-schemas"],
        },
        apps: ["databus-monitor", "databus-schemas", "databus2-relay"],
        app_owners: ["databus-sre@linkedin.com", "streaming-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Resolve Fault",
        hooks_phase_name: "",
        hooks_phase_status: "",
        hooks_enabled: false,
        hooks_plan_id: "",
        fault_types: ["power", "nvme_reboot", "memory", "fusion"],
        check_ids: [
          "ssd_device",
          "cli_created_fusion",
          "cli_created_power",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "6018R-TDLR-BK0-LC019",
          manufacturer: "SuperMicro",
          multiproducts: ["lix-backend"],
          services: ["lix-backend"],
        },
        apps: ["lix-backend"],
        app_owners: ["trex-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Resolve Fault",
        hooks_phase_name: "",
        hooks_phase_status: "",
        ...
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app0626.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "nvme_reboot",
            team: "dctechs",
            description:
              "A NVME SSD has disappeared from the system. Typically, rebooting the machine brings the device back by resetting the NVME bus and the SSD actually is fine. SYSOPS/DCTECHS should work with SRE on rebooting the machine, but likely, their app is hosed any ways. If this is in error and NVME SSDs were intentionally removed from the system, then please remove the device",
            ...
            jira_url:
              "https://jira-stg.corp.example.com:8443/browse/DCTECHS-204529",
            created: "Mon, 09 May 2022 10:03:42 UTC",
        ...
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app1950.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "nvme_reboot",
            team: "dctechs",
            description:
              "A NVME SSD has disappeared from the system. Typically, rebooting the machine brings the device back by resetting the NVME bus and the SSD actually is fine. SYSOPS/DCTECHS should work with SRE on rebooting the machine, but likely, their app is hosed any ways. If this is in error and NVME SSDs were intentionally removed from the system, then please remove the device",
            ...
            jira_url:
              "https://jira-stg.corp.example.com:8443/browse/DCTECHS-204530",
            created: "Mon, 09 May 2022 10:03:28 UTC",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Supermicro NVME 10G copper web node",
          manufacturer: "SuperMicro",
          multiproducts: ["messaging-data-integrity-mt"],
          services: ["messaging-data-integrity-mt"],
        },
        apps: ["messaging-data-integrity-mt"],
        app_owners: ["messaging-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Resolve Fault",
        hooks_phase_name: "",
        hooks_phase_status: "",
        ...
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app1722.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "nvme_reboot",
            team: "dctechs",
            description:
              "A NVME SSD has disappeared from the system. Typically, rebooting the machine brings the device back by resetting the NVME bus and the SSD actually is fine. SYSOPS/DCTECHS should work with SRE on rebooting the machine, but likely, their app is hosed any ways. If this is in error and NVME SSDs were intentionally removed from the system, then please remove the device",
            ...
            jira_url:
              "https://jira-stg.corp.example.com:8443/browse/DCTECHS-204531",
      ...
      },
      {
        ...
        inops_data: {
          ...
          model: "Fat Twin Server Module",
          manufacturer: "SuperMicro",
          multiproducts: ["samza-admin", "samza-yarn"],
          services: ["samza-yarn-nodemanager", "samza-rest-service"],
        },
        apps: ["samza-yarn-nodemanager", "samza-rest-service"],
        app_owners: ["samza-sre@linkedin.com"],
        actionable: "yes",
        workflow_state: "Resolve Fault",
        hooks_phase_name: "",
        hooks_phase_status: "",
        ...
        faults: [
          {
            ...
            detection_system: "obhc",
            health_check_url:
              "https://obhc-api.stg.example.com/ei-ltx1/api/v2/hosts/ltx1-app2578.stg.example.com?show_checks=true&show_extra=true",
            fault_type: "nvme_reboot",
            team: "dctechs",
            description:
              "A NVME SSD has disappeared from the system. Typically, rebooting the machine brings the device back by resetting the NVME bus and the SSD actually is fine. SYSOPS/DCTECHS should work with SRE on rebooting the machine, but likely, their app is hosed any ways. If this is in error and NVME SSDs were intentionally removed from the system, then please remove the device",
            ...
            jira_url:
              "https://jira-stg.corp.example.com:8443/browse/DCTECHS-204528",
            created: "Mon, 09 May 2022 10:03:21 UTC",
